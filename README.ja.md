...
- **設定ページ**：マスタースイッチ、アクセントカラー、音声注入、テンプレート言語、カスタムプロンプト、アバターパス、マスコットのタイトル／サブタイトル、すりガラス背景（オン／パス／アップロード／ぼかし／透明度。GIF は動的背景として自動認識）、UI とサイドバーの不透明度。
...
- DSH Web → **設定 → 魈テーマ**：マスタースイッチ、アクセントカラー、音声注入、テンプレート言語、カスタムプロンプト、アバターパス、マスコットのタイトル／サブタイトル、すりガラス背景（オン／パス／アップロード／ぼかし／透明度。GIF は動的背景として自動認識）、UI 不透明度、サイドバー不透明度。
